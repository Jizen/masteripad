...
- (void)setUpUIWithFrame:(CGRect)frame{
    ...
    UIImageView *arrowImage = [[UIImageView alloc] initWithFrame:CGRectMake(12, 0, 20, 12)];
    arrowImage.image = [UIImage imageNamed:@"sanjiao.png"];
    
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 12, frame.size.width, frame.size.height - 12)];
//    imageView.backgroundColor = UIColorARGB(1, 65, 70, 73);
